...
TEST_SRC_FILES = $(SRC_PATH)lineParser.c 

COMPILE=gcc -c
LINK=gcc
DEPEND=gcc -MM -MG -MF
MATH_LIB = -lm
CFLAGS=-I. -I$(UNITY_PATH) -I$(SRC_PATH) -I$(TEST_PATH) -I$(INCLUDES_PATH) -DTEST -DUNITY_INCLUDE_DOUBLE
...
testprint:
	@make test
	cat tests/build/results/TestLineParser.txt
